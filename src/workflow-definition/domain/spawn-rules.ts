...
const SPAWN_ALLOWED_STATES: ReadonlySet<string> = new Set(['SPAWN', 'RESPAWN', 'DEVELOPING'])
...
function checkStateAllowsSpawn(role: string, currentState: string): SpawnDecision {
