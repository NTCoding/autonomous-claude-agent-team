...
.tl-legend { display: flex; flex-wrap: wrap; gap: 10px; font-size: 11px; color: #666; }
...
.le { padding: 5px 10px; border-bottom: 1px solid #f5f5f5; font-size: 13px; display: flex; flex-wrap: wrap; gap: 3px 8px; align-items: baseline; cursor: default; }
